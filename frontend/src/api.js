const API_BASE_URL = "https://child-tracker.onrender.com/api/children";
...
export const updateChildLocation = async (id, location) => {
  try {
    const res = await axios.put(`https://child-tracker.onrender.com/api/children/update-location/${id}`, location);
    return res.data;
  } catch (error) {
